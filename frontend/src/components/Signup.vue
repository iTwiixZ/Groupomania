<template>
  ...
  >
    ...
    <h1 class="text-center mt-3">
      Ne perds pas de temps et viens nous rejoindres !
    </h1>
    <form class="container mt-5">
      <div class="form-group">
        <input
          ...
          v-model="name"
          type="name"
          placeholder="Nom d'utilisateur: entre 3 et 15 caractères"
          size="50"
          required
        />
      </div>
      ...
      <span class="form-text">
        Doit contenir 8 caractères minimum, une majuscule, une minuscule et un
        caractère spéciale (ex: !, @, #, etc.)
      </span>
    </form>
    <router-link to="/">
      <button
